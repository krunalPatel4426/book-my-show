      ...
      <div className="flex flex-col">
        <div className="flex px-24 bg-slate-900 justify-between">
          ...
          <div className="flex items-center ">
            <button className="bg-red-400 w-36 h-10 text-white rounded-sm">
        ...
        <div className="px-24 bg-zinc-700">
          <div className="flex h-28 flex-row justify-around items-center">
        ...
        <div className="px-24" style={{ backgroundColor: "rgb(51 46 46)" }}>
          <div className="flex flex-col gap-5 my-3">
            <span className="text-gray-400 text-sm font-normal">HELP</span>
            <div className="flex flex-row text-gray-500 text-xs gap-2">
              <a
                className="hover:text-white"
                href="https://in.bookmyshow.com/aboutus"
              >
                About Us |{" "}
              </a>
              <a
                className="hover:text-white"
                href="https://in.bookmyshow.com/contactus"
              >
                Contact Us |{" "}
              </a>
              <a
                className="hover:text-white"
                href="https://in.bookmyshow.com/careers/"
              >
                Current Opening |{" "}
              </a>
              <a
                className="hover:text-white"
                href="https://in.bookmyshow.com/press-release"
              >
                Press Realse |{" "}
              </a>
              <a
                className="hover:text-white"
                href="https://in.bookmyshow.com/press-coverage"
              >
                Press Coverage |{" "}
              </a>
              <a
                className="hover:text-white"
                href="https://in.bookmyshow.com/static/sitemap/"
              >
                Sitemap |{" "}
              </a>
              <a
                className="hover:text-white"
                href="https://support.bookmyshow.com/support/solutions"
              >
                FAQs |{" "}
              </a>
              <a
                className="hover:text-white"
                href="https://in.bookmyshow.com/terms-and-conditions"
              >
                Terms and Conditions |{" "}
              </a>
              <a
                className="hover:text-white"
                href="https://in.bookmyshow.com/privacy"
              >
                Privacy Policy{" "}
              </a>
            </div>
